...
export default class TeamNotesOutDateContentItem extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  sendToRemoveTeamNoteFromOutDateList = () => {
    this.props.socket.emit("send-to-remove-team-note-item-from-out-date", {
    ...
    return (
      <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item">
        {this.state.changeNextRenderInforContent === false ? (
          <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item_______content">
            <div
              style={{
                fontWeight: "bold",
                textAlign: "left",
            ...
            <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item_______create-and-end-date">
              <div>
                <span>Ngày tạo: {this.props.TeamNoteCreateDate}</span>
              </div>
              <div>
                <span style={{ color: "red" }}>
                  Hết hạn: {this.props.TeamNoteEndDate}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item_______content">
            ...
            {this.props.TeamNoteType === "with-excercise" ? (
              <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item_______with-excercise">
                <div>
                ...
                <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item_______excercise-with-infor">
                  <div>
                    <img
        ...
        <div className="user-team_team-menu-and-content__content___notes____content_____out-date______content_______out-date-item_______change-content-and-delete">
        ...
        >
          ...
          <button
            style={{ float: "right", cursor: "pointer" }}
            onClick={() => this.sendToRemoveTeamNoteFromOutDateList()}
          >
            Chắc chắn!!!
          </button>
        </Modal>
